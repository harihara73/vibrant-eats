                   ...
                   <div className="customer-orders-list">
                     {customerOrders.map((order) => (
                       <div 
                         ...
                         style={{ borderLeft: `5px solid ${getStatusColor(order.status)}`, display: 'flex', flexDirection: 'column', gap: '1rem' }}
                       >
                     ...
                     {customerOrders.some(o => o._id === deletingOrderId) && (
                       ...
                       >
                          <div className="confirm-box" onClick={e => e.stopPropagation()}>
                             ...
                             <h3>Archive Order?</h3>
                             <p>Move this order to History. It will no longer be visible on live boards.</p>
                             ...
                             <div style={{ marginTop: '1.25rem', textAlign: 'left' }}>
                                ...
                                <textarea 
                                    ...
                                    placeholder="e.g., Item out of stock, Customer requested change..."
                             ...
                             <div className="confirm-actions">
                                <button className="confirm-btn delete" onClick={() => deletingOrderId && handleDeleteOrder(deletingOrderId)}>Confirm Cancellation</button>
                 ...
                 <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '1rem' }}>
                   <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                     ...
                     <div>
                       ...
                       <div style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>ID: {order._id.slice(-6).toUpperCase()}</div>
                     </div>
                   </div>
                   <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem' }}>
                     <button 
                     ...
                     >
                        <div className="confirm-box" onClick={e => e.stopPropagation()}>
                           ...
                           <div style={{ marginTop: '1.25rem', textAlign: 'left' }}>
                              ...
                              <textarea 
                                 className="handoff-select"
                                 placeholder="Item out of stock, Fake order, etc..."
                                 style={{ width: '100%', height: '80px', padding: '0.75rem', borderRadius: '0.75rem', resize: 'none', background: '#f8fafc', border: '1px solid var(--border)', fontSize: '0.85rem' }}
                                 value={cancelReason}
                                 onChange={(e) => setCancelReason(e.target.value)}
                              />
                           </div>
